...
UseracctWatch::UseracctWatch() {
}

UseracctWatch::UseracctWatch(uint64_t              uw_u_id_,
                             uint64_t              uw_i_id_,
                             uint64_t              uw_i_u_id_,
...
UseracctWatch UseracctWatch::FromJson(const std::string &json) {
  ...
  assert(j["uw_u_id"].is_number());
  model_instance.uw_u_id = (j["uw_u_id"].get<uint64_t>());
  assert(j["uw_i_id"].is_number());
  model_instance.uw_i_id = (j["uw_i_id"].get<uint64_t>());
  assert(j["uw_i_u_id"].is_number());
  model_instance.uw_i_u_id = (j["uw_i_u_id"].get<uint64_t>());
  assert(j["uw_created"].is_string() || j["uw_created"].is_null());
  if (!j["uw_created"].is_null()) {
    model_instance.uw_created = StrfTime(j["uw_created"].get<std::string>());
  }
...
std::string UseracctWatch::ToJson() {
  ...
  j["uw_u_id"] = (uw_u_id);
  j["uw_i_id"] = (uw_i_id);
  j["uw_i_u_id"] = (uw_i_u_id);
  if (uw_created.IsNull()) {
    j["uw_created"] = nullptr;
  } else {
    j["uw_created"] = TimeToString(uw_created.value());
  }
